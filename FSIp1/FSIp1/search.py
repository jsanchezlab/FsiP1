...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Numero de nodos expandidos:", cont)
            return node
...
def ram_graph_search(problem):

    return graph_search(problem, PriorityQueue())


def ram_with_h_graph_search(problem):

    return graph_search(problem, HQueue(problem))
...
class GPSProblem(Problem):
    ...
    def __init__(self, initial, goal, graph) -> object:
